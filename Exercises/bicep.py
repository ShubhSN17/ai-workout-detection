...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        if state == "down" and smooth_angle < UP_THRESHOLD:
            ...
            # Strict validation
            full_curl = min_angle < DEPTH_THRESHOLD
            full_extension = max_angle > 140
            ...
            if full_curl and full_extension and good_balance:
                ...
                if not full_curl:
                    feedback_msg = "Curl higher"
                elif not full_extension:
                    feedback_msg = "Extend fully"
    ...
    cv2.imshow("Bicep Curl AI", frame)
...
if rep_log:
    ...
    out_path = f"logs/bicep_{int(time.time())}.csv"
